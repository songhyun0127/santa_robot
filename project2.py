...
def main(args=None):
    ...
    box_top3 = posx([400.54, 75.94, 166.93, 174, -180, 177.01])
    box_top4 = posx([400.54, 75.94, 105.7, 9.08, -180, 12.03])

    box_top = [box_pos, box_top1, box_top2]
    box_close = [box_top1, box_top3, box_top4]
    ...
    while rclpy.ok():
        ...
        # #     move_periodic(amp=[0,0,0,0,0,5], period=1, atime=1.0, repeat=5, ref=DR_TOOL)
        # #     time.sleep(0.1)
